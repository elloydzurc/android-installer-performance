...
import com.ipms.arena.interfaces.IVersionManager;
...
public class VersionManager implements IVersionManager {
    ...
    public VersionManager(Activity act) {
        ...
        this.customTagHandler = new CustomTag();
    }
    ...
    @Override
    public CustomTag getCustomTagHandler() {
     ...
     */
    @Override
    public void setCustomTag(CustomTag customTagHandler) {
